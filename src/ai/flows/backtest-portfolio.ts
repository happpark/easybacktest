...
export interface ScenarioPoint {
  date: string;
  value: number;       // portfolio value (peak = 1000)
  pctFromPeak: number; // e.g. -23.5
  milestone?: string;  // label if this date is near a milestone
}
...
export async function runScenario(
  ...
  // Dates from peak onwards, intersected across all tickers
  ...
  // Milestone lookup: for each milestone find nearest sampled date
