...
const translations = {
  ko: {
    ...
    // Scenario Experience
    scenario_section_title: '내 포트폴리오, 폭락을 버틸 수 있을까?',
    scenario_section_desc: '실제 위기 속에서 내 전략이 얼마나 무너지는지 직접 확인해보세요',
    scenario_cta: '🔥 폭락장 내구성 테스트',
    scenario_2008: '2008 금융위기',
    scenario_2020: '2020 코로나 폭락',
    scenario_2022: '2022 금리충격',
    scenario_2008_sub: 'S&amp;P 500 기준 최대 -56% 하락',
    scenario_2020_sub: 'S&amp;P 500 기준 최대 -34% 하락',
    scenario_2022_sub: 'S&amp;P 500 기준 최대 -25% 하락',
    scenario_from_peak: '고점 대비',
    scenario_peak_val: '고점 가치',
    scenario_current_val: '현재 가치',
    scenario_trough: '최저점',
    scenario_loading: '시나리오 데이터 불러오는 중...',
    scenario_unavailable: '이 자산은 해당 기간 데이터가 없습니다',
    scenario_slide_hint: '슬라이더를 밀어 시간을 이동하세요',
    scenario_close: '닫기',
    scenario_max_dd: '최대 하락',
    scenario_recovered: '✓ 고점 회복',
  ...
  en: {
    ...
    // Scenario Experience
    scenario_section_title: 'Can Your Portfolio Survive a Crash?',
    scenario_section_desc: 'Test how much your strategy actually drops when markets collapse',
    scenario_cta: '🔥 Run Crash Resilience Test',
    scenario_2008: '2008 Financial Crisis',
    scenario_2020: '2020 COVID Crash',
    scenario_2022: '2022 Rate Shock',
    scenario_2008_sub: 'S&amp;P 500 dropped up to -56%',
    scenario_2020_sub: 'S&amp;P 500 dropped up to -34%',
    scenario_2022_sub: 'S&amp;P 500 dropped up to -25%',
    scenario_from_peak: 'From peak',
    scenario_peak_val: 'Peak value',
    scenario_current_val: 'Current value',
    scenario_trough: 'Trough',
    scenario_loading: 'Loading scenario data...',
    scenario_unavailable: 'No data available for this period',
    scenario_slide_hint: 'Slide to travel through time',
    scenario_close: 'Close',
    scenario_max_dd: 'Max Drawdown',
    scenario_recovered: '✓ Peak Recovered',
