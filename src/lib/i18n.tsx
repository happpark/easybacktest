...
const translations = {
  ko: {
    ...
    result_dividend: '배당률',
    tooltip_cagr: '매년 평균 얼마나 벌었는지예요. 높을수록 좋아요.',
    tooltip_mdd: '최악의 경우 얼마나 하락했는지예요. 낮을수록(덜 손실) 좋아요.',
    tooltip_volatility: '수익률이 얼마나 출렁이는지예요. 낮을수록 안정적이에요.',
    tooltip_sharpe: '위험 대비 수익 효율이에요. 1.0 이상이면 양호해요.',
