...
const translations = {
  ko: {
    ...
    result_dividend: '배당',
    tooltip_cagr: '투자 기간 동안 매년 평균적으로 얼마나 수익이 났는지를 나타내요. 높을수록 좋아요.',
    tooltip_mdd: '가장 높았던 시점부터 가장 낮았던 시점까지 최대로 떨어진 폭이에요. 낮을수록(덜 떨어질수록) 좋아요.',
    tooltip_volatility: '수익률이 얼마나 들쭉날쭉한지를 나타내요. 낮을수록 안정적인 포트폴리오예요.',
    tooltip_sharpe: '감수한 위험 대비 수익이 얼마나 효율적인지를 나타내요. 높을수록 좋아요.',
    tooltip_dividend: '보유 종목에서 연간 받을 수 있는 평균 배당 수익률이에요.',
  ...
  en: {
    ...
    tooltip_cagr: 'Average annual return over the investment period. Higher is better.',
    tooltip_mdd: 'The largest peak-to-trough decline. Lower (less negative) means the portfolio held up better during downturns.',
    tooltip_volatility: 'How much returns fluctuate over time. Lower means a smoother, more stable ride.',
    tooltip_sharpe: 'How efficiently returns are earned per unit of risk taken. Higher is better.',
    tooltip_dividend: 'Estimated annual dividend yield from the portfolio\'s holdings.',
