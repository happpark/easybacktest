...
const translations = {
  ko: {
    ...
    // Scenario Experience
    scenario_section_title: '폭락장에서 내 포트폴리오는?',
    scenario_section_desc: '실제 위기 시나리오를 슬라이드하며 체험해보세요',
    scenario_cta: '시나리오 체험하기',
  ...
  en: {
    ...
    // Scenario Experience
    scenario_section_title: 'How would your portfolio survive a crash?',
    scenario_section_desc: 'Slide through real crisis scenarios and feel the drop',
    scenario_cta: 'Experience a Scenario',
