...
const translations = {
  ko: {
    ...
    scenario_2008_sub: '리먼브라더스 파산 · -56%',
    scenario_2020_sub: '코로나19 팬데믹 · -34%',
    scenario_2022_sub: 'Fed 급격 금리인상 · -25%',
  ...
  en: {
    ...
    scenario_2008_sub: 'Lehman collapse · -56%',
    scenario_2020_sub: 'COVID-19 pandemic · -34%',
    scenario_2022_sub: 'Fed rate hike cycle · -25%',
