...
export default function AlphaFlowApp() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto relative overflow-hidden bg-background font-body">
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto glass-morphism h-20 px-8 flex items-center justify-between border-t border-white/10 z-50">
        <button
